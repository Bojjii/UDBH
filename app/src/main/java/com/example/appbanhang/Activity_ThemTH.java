...
public class Activity_ThemTH extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_themthuonghieu);
        storageReference = FirebaseStorage.getInstance().getReferenceFromUrl("gs://appbanhang-19ff7.appspot.com");
        anhxa();
    ...
    private void themTH(){
        ...
        String id = edtmathuonghieu.getText().toString().trim();
        String ten = edttenthuonghieu.getText().toString().trim();
        ThuongHieu thuongHieu = new ThuongHieu(id,ten,hinhTH);
        reference.child(id).setValue(thuongHieu);
        Toast.makeText(Activity_ThemTH.this,"Thêm thương hiệu thành công",Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    private void uploadImageToFirebase(String name, Uri contentUri) {
        ...
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(Activity_ThemTH.this, "Image Is Uploaded.", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Activity_ThemTH.this, "Upload Failled.",Toast.LENGTH_SHORT).show();
            }
        });
    }
